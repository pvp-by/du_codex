...
---@class vec2
---@param zero vec3 A vector representing the origin point (0, 0) - Only available OUTSIDE instances
---@param unit_x vec3 A vector representing the X axis (1, 0) - Only available OUTSIDE instances
---@param unit_y vec3 A vector representing the Y axis (0, 1) - Only available OUTSIDE instances
---@param x number The X component of the vector - Only available INSIDE instances
---@param y number The Y component of the vector - Only available INSIDE instances
vec2 = {}
...
---@class vec3
---@param zero vec3 A vector representing the origin point (0, 0, 0) - Only available OUTSIDE instances
---@param unit_x vec3 A vector representing the X axis (1, 0, 0) - Only available OUTSIDE instances
---@param unit_y vec3 A vector representing the Y axis (0, 1, 0) - Only available OUTSIDE instances
---@param unit_z vec3 A vector representing the Z axis (0, 0, 1) - Only available OUTSIDE instances
---@param x number The X component of the vector - Only available INSIDE instances
---@param y number The Y component of the vector - Only available INSIDE instances
---@param z number The Z component of the vector - Only available INSIDE instances
vec3 = {}
--- Calculates the distance between two points
...
---@param id number The unique ID of the celestial body
---@param name DUMultiLanguageString The localized name of the celestial body
---@param type DUMultiLanguageString The localized type of the celestial body
---@param biosphere DUMultiLanguageString The localized biosphere of the celestial body
---@param classification DUMultiLanguageString The localized classification of the celestial body
---@param habitability DUMultiLanguageString The localized habitability of the celestial body
---@param description DUMultiLanguageString The localized description of the celestial body
---@param iconPath string The image path to the icon representing the celestial body
---@param hasAtmosphere boolean Whether the celestial body has an atmosphere or not
---@param isSanctuary boolean Whether the celestial body is a Sanctuary moon or not
---@param isInSafeZone boolean Whether the celestial body is on the safe zone or not
---@param systemId number The ID of the solar system the celestial body belongs to
---@param positionInSystem number The position of the celestial body on the solar system
---@param satellites number[] The IDs of each satellite belonging to the celestial body
---@param center table The world coordinates of the center of the celestial body
---@param gravity number The gravity of the celestial body, in m/s²
---@param radius number The radius of the celestial body, in meters from its center, represents altitude 0m (sea level)
---@param atmosphereRadius number The radius of the celestial body atmosphere, in meters from its center
---@param atmosphereThickness number The thickness of the atmosphere, in meters (around the same as the atmosphereRadius - radius)
---@param GM number The celestial body mass in units of the product of the gravitational constant (G) and the mass of the star (M), also known as the heliocentric gravitational constant
---@param surfaceArea number The celestial body total surface area, in m²
---@param surfaceAverageAltitude number The celestial body average surface altitude, in meters above sea level
---@param surfaceMaxAltitude number The celestial body maximum surface altitude, in meters above sea level
---@param surfaceMinAltitude number The celestial body minimum surface altitude, in meters above sea level
---@param ores DUMultiLanguageString[] A list of all the ores that can be found on the celestial body
---@param territories number How many territories the celestial body has in total
